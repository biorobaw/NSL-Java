...
import com.github.biorobaw.nslj.cmd.NslThreadCommands;
import com.github.biorobaw.nslj.display.NslCanvas;
import com.github.biorobaw.nslj.display.NslColor;
import com.github.biorobaw.nslj.display.NslDisplaySystem;
import com.github.biorobaw.nslj.display.NslFrame;
import com.github.biorobaw.nslj.lang.*;
import com.github.biorobaw.nslj.math.*;
import tcl.lang.*;

import java.util.Vector;

@SuppressWarnings({"FieldCanBeLocal", "unused", "UnusedAssignment", "WeakerAccess"})
public class s_Nsl implements Command {
                ...
                case 22:
                    ...
                    if (hasParenthesis(variable)) {
                        ...
                        try {
                            ...
                            Vector<Integer> v = getIndices(indices);
		    	    	...
		    	    	System.out.println("Index["+i+"]="
                            ...
                            if (num == null) {
                                ...
                                if (num instanceof NslNumeric0) {
                                    ...
                                    tclInterp.setResult("" +
                                            ((NslNumeric1) num).getdouble(elem1));
                                    ...
                                    tclInterp.setResult("" +
                                            ((NslNumeric2) num).getdouble(elem1,
                                                    elem2));
                                    ...
                                    tclInterp.setResult("" +
                                            ((NslNumeric3) num).getdouble(elem1,
                                                    elem2, elem3));
                                    ...
                                    tclInterp.setResult("" + ((NslNumeric4) num).getdouble(elem1,
                                            elem2, elem3,
                                            elem4));
                                }
                            }
                            ...
                            if (num == null) {
                                ...
                                if (num instanceof NslNumeric0) {
                                    ...
                                    if (argv.length >= 4) {
                                        ...
                                        echo("" + ((NslNumeric1) num).getdouble(elem1));
                                    }
                                    ...
                                    if (argv.length >= 4) {
                                        ...
                                        echo("" + ((NslNumeric2) num).getdouble(elem1,
                                                elem2));
                                    }
                                    ...
                                    if (argv.length >= 4) {
                                        ...
                                        echo("" + ((NslNumeric3) num).getdouble(elem1,
                                                elem2, elem3));
                                    }
                                    ...
                                    if (argv.length >= 4) {
                                        ...
                                        echo("" + ((NslNumeric4) num).getdouble(elem1,
                                                elem2, elem3,
                                                elem4));
                                    }
                                }
    ...
    static private String tail(String s) {
        ...
        return (s.substring(lastdot(s) + 1));
    }
    ...
    private Vector<Integer> getIndices(String indices)
