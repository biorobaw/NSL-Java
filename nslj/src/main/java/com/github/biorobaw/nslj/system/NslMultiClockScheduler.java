...
import com.github.biorobaw.nslj.display.NslDisplaySystemVector;
import com.github.biorobaw.nslj.lang.NslClass;
...
@SuppressWarnings({"WeakerAccess", "unchecked", "Duplicates"})
public class NslMultiClockScheduler extends NslScheduler {

    NslSystem system;
    Vector<NslClockSchedulerModuleVector> clockRunList;   // a list of vectors, in which contains
    // modules with a same run time step size
    Vector<NslTrainClockSchedulerModuleVector> clockTrainList; // a list of vectors, in which contains
    ...
    public void addModuleToClockRunList(NslModule module) {
        ...
        Enumeration<NslClockSchedulerModuleVector> E = clockRunList.elements();
    ...
    public void addModuleToClockTrainList(NslModule module) {
        ...
        Enumeration<NslTrainClockSchedulerModuleVector> E = clockTrainList.elements();
