...
class NslTreeNode extends TreeNode {
    ...
    public NslTreeNode(Object po, Image pDefault, NslVariableInput pNslVariableInput) {
        super(po, pDefault);
        mNslVariableInput = pNslVariableInput;
    }

    public NslTreeNode(Object po, Image pDefault, Image pCollapse, NslVariableInput pNslVariableInput) {
