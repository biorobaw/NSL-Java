...
import com.github.biorobaw.nslj.system.NslInterpreter;
...
*/
    ...
    private Menu createMenu(String name, String[] items) {
        ...
        for (String item : items) m.add(new MenuItem(item));
