...
import com.github.biorobaw.nslj_models.generative_pc_model_gonzalo.model.RobotFactory;
...
//		return result + 4; // 4 es la posicion del cero en direcciones relativas
	...
	/* devuelven un número entre cero y uno.
	...
	public static final double DELTA_STEP = Configuration.getDouble("Simulation.DeltaStep")/100;///Math.sqrt(2);
