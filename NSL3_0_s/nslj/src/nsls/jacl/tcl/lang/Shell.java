...
@SuppressWarnings({"WeakerAccess", "unused", "InfiniteLoopStatement", "ResultOfMethodCallIgnored", "UnusedAssignment"})
...
//		int limit = 10;
                    ...
                    if (historyObjs.size() > limit && historyObjs.size() > 0) {
                        TclObject cobj = historyObjs.elementAt(0);
