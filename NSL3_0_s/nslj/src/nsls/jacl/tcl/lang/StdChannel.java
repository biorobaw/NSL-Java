...
@SuppressWarnings({"unused", "ResultOfMethodCallIgnored", "RedundantThrows"})
class StdChannel extends Channel {
     ...
     *
     * @param type int that equals stdin, stdout, stderr
     ...
     * @param mode   to begin incrementing the stream pointer; beginning,
