...
@SuppressWarnings({"Duplicates", "WeakerAccess", "UnusedAssignment", "unused"})
class Parser {
    ...
    // termination information.
    {
        ...
        while (true) {
            ...
            if ((type & TYPE_SUBS) == 0) {
                ...
                do {
                    script_index++;
                } while (((typeTable[script_array[script_index]]) & (mask | TYPE_SUBS)) == 0);
...
//should the nest level be changed???
    ...
    eval2(
        ...
        nested = (interp.evalFlags & TCL_BRACKET_TERM) != 0;
        interp.evalFlags &= ~TCL_BRACKET_TERM;

        try {

            do {
                parse = parseCommand(interp, script_array, src_index,
