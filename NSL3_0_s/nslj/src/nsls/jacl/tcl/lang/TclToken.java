...
class TclToken {
    ...
    toString() {
        ...
        sbuf.append("\n  String:      ").append(getTokenString());
        sbuf.append("\n  String Size: ").append(getTokenString().length());
        sbuf.append("\n  ScriptIndex: ").append(script_index);
        sbuf.append("\n  NumComponents: ").append(numComponents);
        sbuf.append("\n  Token Size: ").append(size);
