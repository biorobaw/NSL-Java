...
@SuppressWarnings({"WeakerAccess", "unused", "Duplicates", "UnusedAssignment", "FinalStaticMethod", "RedundantThrows", "ConstantConditions", "ResultOfMethodCallIgnored"})
public class Util {
