...
class ArrayCmd implements Command {
    ...
    public void cmdProc(Interp interp, TclObject[] argv)
        ...
        Var var = interp.varFrame.varTable.get(argv[2].toString());
        ...
        switch (index) {
            ...
            case OPT_SET: {
                ...
                for (i = 0; i < size; i++) {
                    name2 = Objects.requireNonNull(TclList.index(interp, argv[3], i++)).toString();
                    strValue = Objects.requireNonNull(TclList.index(interp, argv[3], i)).toString();
            ...
            case OPT_SIZE: {
                ...
                if (notArray) {
                    ...
                    int size = 0;
                    for (Enumeration e = table.keys(); e.hasMoreElements(); ) {
                        Var elem = (Var) table.get(e.nextElement());
                        if ((elem.flags & Var.UNDEFINED) == 0) {
                            size++;
                        }
                    }
