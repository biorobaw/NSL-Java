    ...
    private static boolean loadClasses() {
        switch (jvm) {
            case MRJ_2_0:
                ...
                } catch (ClassNotFoundException | NoSuchMethodException | NoSuchFieldException | IllegalAccessException ex) {
            ...
            case MRJ_2_1:
                ...
                } catch (ClassNotFoundException | NoSuchFieldException | NoSuchMethodException | SecurityException | IllegalAccessException ex) {
                    errorMessage = ex.getMessage();
                    return false;
                }
                break;
