    ...
    public void updateScope(NslScope scope) {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            if (!scope.addLocalVar(temp)) {
                ...
                NslCompiler.printError("ASTMethodDeclaration", "Variable " + names[i] + " was already defined in this scope", variable.getFirstToken().beginLine, variable.getFirstToken().beginColumn);
            }
        }
    }
