        ...
        for (int i = 1; i < childNum; i++) {
            ...
            if (operator.equals("^")) {
                if (((isArray1 || isArray2) && canApplyElemMult(type1, type2))) {
                    NslCompiler.printError("ASTExclusiveOrExpression", "Trying to multiply non compatible types: " + type1 + " and " + type2, oper.getFirstToken().beginLine, oper.getFirstToken().beginColumn);
                    return "";
                    ...
                    NslCompiler.printError("ASTExclusiveOrExpression", "Trying to multiply wrong dimensions", oper.getFirstToken().beginLine, oper.getFirstToken().beginColumn);
                    return "";
                } else {
